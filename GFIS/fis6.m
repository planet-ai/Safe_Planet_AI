function [output] = fis6(x,y,chrom)
...
%membership of y
mu_y(1,:)=chrom(100:102);
mu_y(2,:)=chrom(103:105);
mu_y(3,:)=chrom(106:108);
% mu_y(4,:)=chrom(25:27);
% mu_y(5,:)=chrom(28:30);

%membership of output
mu_output(1,:)=chrom(145:147);
mu_output(2,:)=chrom(148:150);
mu_output(3,:)=chrom(151:153);
