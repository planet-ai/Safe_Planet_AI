function [output] = fis9(x,y,chrom)

%membership of x
mu_x(1,:)=chrom(145:147);
mu_x(2,:)=chrom(148:150);
mu_x(3,:)=chrom(151:153);
% mu_x(4,:)=chrom(10:12);
% mu_x(5,:)=chrom(13:15);

%membership of y
mu_y(1,:)=chrom(154:156);
mu_y(2,:)=chrom(157:159);
mu_y(3,:)=chrom(160:162);
% mu_y(4,:)=chrom(25:27);
% mu_y(5,:)=chrom(28:30);

%membership of output
mu_output(1,:)=chrom(172:174);
mu_output(2,:)=chrom(175:177);
mu_output(3,:)=chrom(178:180);
